...
np.savez_compressed(path+"train_40dd_wolabel.npz", inputs = X_train, outputs=Y_train)
#%% save scaler
from sklearn.externals import joblib
joblib.dump(scaler, "/media/gabor/ALL/MachineLearning/kaggle/TensorFlow_Speech_Recognition/scripts/scaler_40dd_wolabel.pkl")
