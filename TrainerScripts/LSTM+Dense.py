...
#%%
data=[]
#from_file=np.load("/home/gabor/Audio/traindata_endtoend_sep_nofilter.npy") #this returns an object variable
...
data=[]
#from_file=np.load("/home/gabor/Audio/testdata_endtoend_sep_nofilter.npy") #this returns an object variable
...
data=[]
#from_file=np.load("/home/gabor/Audio/validdata_endtoend_sep_nofilter.npy") #this returns an object variable
...
#%%
model= Sequential()
model.add(LSTM(units=500, return_sequences=True, input_shape=(shape[0], shape[1])))
