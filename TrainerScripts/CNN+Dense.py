...
#%%
data=[]
#from_file=np.load("/home/gabor/DeepLearningHomework/vitmav45-2017-DeepImpact/traindata.npy") #this returns an object variable
...
data=[]
#from_file=np.load("/home/gabor/DeepLearningHomework/vitmav45-2017-DeepImpact/testdata.npy") #this returns an object variable
...
data=[]
#from_file=np.load("/home/gabor/DeepLearningHomework/vitmav45-2017-DeepImpact/validdata.npy") #this returns an object variable
...
#%% checkpoint and early stopping used, saving only the best model
patience=30 
...
#%%
#train model
model.fit(X_train, Y_train, batch_size=20, epochs=1000, validation_data=(X_valid, Y_valid),callbacks=[checkpointer, early_stopping])
#%%
model = load_model(sys.argv[4]) #load model back
